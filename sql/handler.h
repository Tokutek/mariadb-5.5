...
struct handlerton
{
  ...
  */
   ...
   int (*fill_is_table)(handlerton *hton, THD *thd, TABLE_LIST *tables, 
                        class Item *cond, 
                        enum enum_schema_tables);
   void (*handle_fatal_signal)(handlerton *hton, THD *thd, int sign);
...
public:
  ...
  */
  ...
  // Table is renamed
  static const HA_ALTER_FLAGS ALTER_RENAME_56            = 1L << 18;
  ...
  static const HA_ALTER_FLAGS ALTER_PARTITION_56         = 1L << 23;
  ...
  static const HA_ALTER_FLAGS ALTER_TABLE_REORG_56       = 1L << 26;

  // Remove partitioning
  static const HA_ALTER_FLAGS ALTER_REMOVE_PARTITIONING_56  = 1L << 27;

  // Partition operation with ALL keyword
  static const HA_ALTER_FLAGS ALTER_ALL_PARTITION_56        = 1L << 28;
